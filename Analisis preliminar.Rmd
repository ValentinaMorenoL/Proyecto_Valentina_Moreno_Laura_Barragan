...
Como variable dependiente se consideraron a los niños entre 5 y 17 años de edad que en las últimas cuatro semanas hicieron alguna diligencia para conseguir un trabajo o instalar un negocio, utilizando la variable P6280 de la Enti_niños, que tiene 2 categorias de respuesta que son:
...
El objetivo central del siguiente documento es determinar en qué medida los diferentes factores socioeconómicos influyen en el trabajo infantil de los niños entre los 5 y 17 de edad en Bogotá durante el año 2011, para ello se realizará una descripción estadística de las variables y posteriormente se llevará a cabo una regresión lineal, utilizando como variable explicada principal la principal actividad del infante durante la semana anterior a la encuesta, la variable explicativa principal es la disminución de ingresos en el último año como aproximación al nivel de pobreza del hogar; además, se agregaron 4 variables de control para evitar un sesgo por variable omitida.

La primera regresión que se analizará tendrá en cuenta únicamente el efecto de la disminución de los ingresos en el hogar durante los últimos 12 meses sobre la principal actividad en la que los niños emplearon su tiempo la semana pasada. La ecuación es la siguiente:
...
Con la información de la Tabla 1 podemos inferir que, en primer lugar, no tiene ningun sentido interpretar el coeficiente $\beta_0$ teniendo en cuenta que la variable dependiente es binaria y la variable explicativa tiene mas de 2 categorias de respuesta, por lo tanto esta constante no se tiene en cuenta. 

El coeficiente de la variable Adult_disminucion_ing2 indica que en los hogares en los que no diminuyo el ingreso en los ultimos 12 meses tienen 0,00004289 menos probabilidad en comparación con los hogares en donde si disminuyo el ingreso en ese periodo de tiempo, de que los niños buscaran trabajo durante las últimas 4 semanas.

Además, el coeficiente de la variable Adult_disminucion_ing3 indica que en los hogares que no tuvieron ingresos en los ultimos 12 meses tienen 0,001,725 más probabilidad en comparación con los hogares en donde si disminuyo el ingreso en ese periodo de tiempo, de que los niños buscaran trabajo durante las últimas 4 semanas.
...
Adicionalmente, el $R^2$ (0,00006) indica que este modelo explica tan solo el 0.006% de la variación en Ninos_trabajo.
...
El coeficiente de la variable Adult_disminucion_ing2 indica que en los hogares en los que no diminuyó el ingreso en los ultimos 12 meses tienen 0.00008148 menos probabilidad en comparación con los hogares en donde si disminuyo el ingreso en ese periodo de tiempo, de que los niños buscaran trabajo durante las últimas 4 semanas, ceteris paribus.

Además, el coeficiente de la variable Adult_disminucion_ing3 cambio de sentido, indicando que en los hogares que no tuvieron ingresos en los ultimos 12 meses tienen 0.001731 menos probabilidad en comparación con los hogares en donde si disminuyo el ingreso en ese periodo de tiempo, de que los niños buscaran trabajo durante las últimas 4 semanas, controlando por todo lo demás.

El coeficiente de la variable Nino_personas_hogar es -0.0006791, este coeficiente indica que si el número de personas que viven en el hogar aumenta en una unidad, la probabilidad de que los niños buscaran trabajo en el último mes disminuiría en 0.0006791 unidades, dejando constante las demás variables.

El coeficiente de la variable Nino_sexo indica que, dejando todo lo demás constante, las mujeres tienen 0.002945 menos probabilidad que los hombres de haber buscado trabajo en las ultimas cuatro semanas.

El coeficiente de la variable Nino_edad es 0.003956, este coeficiente indica que ante un aumento de un año en la edad de los niños, la probabilidad de que los niños buscaran trabajo en el último mes aumentaría en 0.003956 unidades, ceteris paribus.

El coeficiente de la variable Nino_educ es -0.06502, indicando que los niños que asisten a una institución de educación formal tienen 0.06502 menos probabilidad en comparación con los que no asisten de haber buscado trabajo durante las últimas 4 semanas, manteniendo todo lo demás constante.

De acuerdo con el valor p, al igual que en el modelo anterior,ninguno de los coeficientes de la variable Adult_disminucion_ing son estadísticamente significativos, ya que los valores p son mayores al 0,1, en otras palabras, no se puede rechazar la hipótesis nula de que los coeficiente son iguales a 0, en favor de la hipótesis alternativa de que los coeficientes son diferente a 0.

En contraste, los asteriscos al lado del valor p indican que los coeficientes del las variables de edad, educación, sexo y número de personas en el hogar son estadisticamente significativos. Las dos primeras variables  a un nivel de confianza del 99.9%, pues el valor p es menor a 0,001, el sexo y el numero de personas en el hogar a un nivel de confianza del 95% y del 90% respectivamente. 

El $R^2$ (0.03749) aumentó como es natural cuando se agregan variables en una regresión. En este caso, es mas acertado enfocarnos en el $R^2$ Ajustado, el cual ajusta el valor del $R^2$ para quitar el efecto del aumento natural que se da simplemente por agregar más variables al modelo. En este caso el $R^2$ Ajustado aumentó de 0.00001093 a 0.03735, lo cual indica que con las 5 variables adicionales, este nuevo modelo explica el 3,735% de la variiacion en Ninos_trabajo.

Finalmente, se realizo una regresion incluyendo la interacción entre las variables *Nino_sexo* y *Nino_educ*, para evaluar en que proporción el efecto de ser mujer en *Y*, está mediado por la asistencia del niño a una institución de educación formal.
...
Los coeficientes de la variable Adult_disminucion_ing siguen sin ser significativos y con signo negativos, la probabilidad de afectar la variable dependiente vario en una proporcion mínima. 

De igual forma, los coeficientes de la variable de sexo, número de personas en el hogar, edad y educacion de los niños varian muy poco y continuan teniendo el mismo nivel de significancia.

En este modelo es importante analizar el coeficiente $\beta_5$, que nos muestra la interacción entre el sexo y la asistencia de los niños a una institución de educación formal. De acuerdo con los resultados de esta regresión las mujeres tienen, en promedio, 0.02929 menos probabilidad que los hombres de haber buscdado trabajo en el último mes , y los niños que reciben una eduación formal tienen 0.07951 menos probabilidad que los que no asisten al colegio de haber buscado trabajo en las últimas 4 semanas. La interacción Nino_sexo:Nino_educ indica que para las mujeres en que asisten a una institución de educacion formal es 0.02779 más probable que para los hombres que asisten al colegio o la universidad haber buscado trabajo durante el último mes, además este coeficiente es estadísticamente significativo, con un nivel de confianza del 99.9%, pues el valor p es menor a 0,001. 

Nuevamente el $R^2$ (0.03749) 0.03824,	Adjusted R-squared:  0.03808  aumentó como es natural cuando se agregan variables en una regresión, pero este aumento fue tan solo de 0.00075 puntos. Como se habia mencionado anteriormente, es mas acertado enfocarnos en el $R^2$ Ajustado, que en este caso  aumentó de 0.00001093 a 0.03735 a  0.03808, lo cual indica que incluyendo la interaccion entre el sexo y la educacion de los niños, el nuevo modelo explica el 3,808% 3,735% de la variiacion en Ninos_trabajo, un 0.073% más en comparación con el modelo 2 y un 3.8% mas comparado con el primer modelo.
...
```{r}
gg_diagnose(modelo_3)
```

## Resumen de los resultados

Para lograr visualizar de manera mas clara las diferencias entre los tres modelos que se analizaron, se realizo la Grafica 1, donde se muestran los cambios en los coeficientes para cada ecuación estimada.
